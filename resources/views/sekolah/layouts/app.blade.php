...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('sekolah.dashboard') }}">
                Simpegah
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @if (Auth::guard('sekolah')->guest())
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('sekolah.login') }}">{{ __('Login') }}</a>
                        </li>
                      <!--  <li class="nav-item">
                            <a class="nav-link" href="{ route('sekolah.register') }}">{ __('register') }}</a>
                        </li>-->
